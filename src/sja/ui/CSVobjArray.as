package sja.ui 
{
	 ...
	 * Utility class used to parse CSV into object Arrays, a much simplier way of handling simple column style data than either JSON or XML
	 * works well for both PHP and PERL output allowing for very simple external scripts if the Data required is not complex
	 */
	public class CSVobjArray 
	{
